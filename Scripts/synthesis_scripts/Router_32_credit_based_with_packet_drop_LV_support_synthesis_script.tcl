...
elaborate counter_threshold_classifier -architecture behavior -library DEFAULT -parameters "counter_depth = 8, healthy_counter_threshold = 4, faulty_counter_threshold = 4"
...
elaborate router_credit_based_parity_lv -architecture behavior -library DEFAULT -parameters "DATA_WIDTH = 32, DATA_WIDTH_LV = 11, current_address = 5, Rxy_rst = 60, Cx_rst = 15, healthy_counter_threshold = 8, faulty_counter_threshold = 4, counter_depth = 4, NoC_size = 4"
# clock period set to 10 ns
create_clock -name "clk" -period 10 -waveform { 0 5  }  { clk  }
# reset signal
set_dont_touch reset
