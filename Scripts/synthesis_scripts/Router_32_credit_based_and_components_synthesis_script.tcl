...
elaborate LBDR -architecture behavior -library DEFAULT -parameters "cur_addr_rst = 5, Rxy_rst = 60, Rxy_rst = 60, Cx_rst = 15, NoC_size = 4"
# clock period set to 10 ns
create_clock -name "clk" -period 10 -waveform { 0 5  }  { clk  }
# reset signal
set_dont_touch reset
...
elaborate router_credit_based -architecture behavior -library DEFAULT -parameters "DATA_WIDTH = 32, current_address = 5, Rxy_rst = 60, Cx_rst = 15, NoC_size = 4"
# clock period set to 10 ns
create_clock -name "clk" -period 10 -waveform { 0 5  }  { clk  }
# reset signal
set_dont_touch reset
