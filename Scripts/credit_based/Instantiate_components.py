...
def instantiate_routers(noc_file, network_dime, add_parity, add_lv, add_packet_drop, add_FC, add_SHMU, healthy_counter_threshold, faulty_counter_threshold, counter_depth):
