...
def write_do_file(program_argv, net_file_name, net_tb_file_name, wave_do_file_name):
    ...
    if program_argv['credit_based_FC'] == False and program_argv['add_checkers'] == False:
    ...
    elif program_argv['credit_based_FC'] == False and program_argv['add_checkers'] == True:

        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/Checkers/Modules_with_checkers_integrated/Handshaking_FC/All_checkers/Arbiter_one_hot_with_checkers/Arbiter_checkers.vhd\"\n")
        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/Checkers/Modules_with_checkers_integrated/Handshaking_FC/All_checkers/Arbiter_one_hot_with_checkers/Arbiter_one_hot_with_checkers.vhd\"\n")
        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/Checkers/Modules_with_checkers_integrated/Handshaking_FC/All_checkers/FIFO_one_hot_with_checkers/FIFO_control_part_checkers.vhd\"\n")
        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/Checkers/Modules_with_checkers_integrated/Handshaking_FC/All_checkers/FIFO_one_hot_with_checkers/FIFO_one_hot_with_checkers.vhd\"\n")
        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/Checkers/Modules_with_checkers_integrated/Handshaking_FC/All_checkers/LBDR_with_checkers/LBDR_checkers.vhd\"\n")
        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/Checkers/Modules_with_checkers_integrated/Handshaking_FC/All_checkers/LBDR_with_checkers/LBDR_with_checkers.vhd\"\n")
        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/Hand_Shaking_FC/xbar.vhd\"\n")

    elif program_argv['credit_based_FC'] == True and program_argv['add_checkers'] == False:

        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/credit_based_flow_control/arbiter_in.vhd\"\n")
        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/credit_based_flow_control/arbiter_out.vhd\"\n")
        do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/credit_based_flow_control/allocator.vhd\"\n")
    ...
    if program_argv['add_FI'] == True:
        if program_argv['credit_based_FC'] == True:
            do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/credit_based_flow_control/Fault_injector.vhd\"\n")
        else:
    ...
    if program_argv['credit_based_FC'] == False:
        ...
        elif program_argv['add_parity'] == False and program_argv['add_checkers'] == True:
            do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/Hand_Shaking_FC/Router_32_bit_with_full_set_of_checkers.vhd\"\n")

        elif program_argv['add_parity'] == False and program_argv['add_checkers'] == False:
            do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/Hand_Shaking_FC/Router_32_bit.vhd\"\n")

    elif program_argv['credit_based_FC'] == True:
        if program_argv['add_parity'] == True:
            do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/credit_based_flow_control/ParityChecker_packet_detector.vhd\"\n")
            do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/credit_based_flow_control/Router_32_bit_credit_based_parity.vhd\"\n")
        else:
            do_file.write("vcom \"" + SRC_DIR + "/EHA/RTL/credit_based_flow_control/Router_32_bit_credit_based.vhd\"\n")
    ...
    if program_argv['credit_based_FC'] == False:
        ...
        do_file.write("vcom \"" + SRC_DIR + "/Test/TB/TB_Package_32_bit_credit_based.vhd\"\n")
