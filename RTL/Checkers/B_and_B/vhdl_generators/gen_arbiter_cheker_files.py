...
def gen_arbiter_checkers(checker_id):
	...
	if '1' in checker_id:
		...
		arbiter_checker_vhd.write("--	if (DCTS = '1' and RTS_FF = '1' and (Req_N = '1' or Req_E = '1' or Req_W = '1' or Req_L = '1') and Xbar_sel /= "0001" and Xbar_sel /= "0010" and Xbar_sel /= "0100" and Xbar_sel /= "1000" ) then\n")
		arbiter_checker_vhd.write("	if (Xbar_sel /= "00000" and Xbar_sel /= "00001" and Xbar_sel /= "00010" and Xbar_sel /= "00100" and Xbar_sel /= "01000" and Xbar_sel /= "10000") then \n")
	...
	if '2' in checker_id:
		arbiter_checker_vhd.write("-- If there is no request for arbitration and the next router/NI is also not ready to receive any flits, the arbiter must not active any Grant signals in its output!\n")
		arbiter_checker_vhd.write("process(Req_N, Req_E, Req_W, Req_S, Req_L, DCTS, RTS_FF_in, Grant_N, Grant_E, Grant_W, Grant_S, Grant_L) begin\n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '0' and Req_W = '0' and Req_S = '0' and Req_L = '0') and (Grant_N = '1' or Grant_E = '1' or Grant_W = '1' or Grant_S = '1' or Grant_L = '1') ) then\n")
	...
	if '4' in checker_id:
		arbiter_checker_vhd.write("process(state, RTS_FF, DCTS, RTS_FF_in) begin\n")
		arbiter_checker_vhd.write("	if ( (state = North or state = East or state = West or state = South or state = Local) and  RTS_FF = '0' and DCTS = '0' and RTS_FF_in = '0') then \n")
	...
	if '7' in checker_id:
		...
		arbiter_checker_vhd.write("process (DCTS, RTS_FF, Req_N, Req_E, Req_W, Req_S, Req_L, state_in, Grant_N, Grant_E, Grant_W, Grant_S, Grant_L) begin\n")
		arbiter_checker_vhd.write("if (DCTS = '1' and RTS_FF = '1' and (Req_N = '1' or Req_E = '1' or Req_W = '1' or Req_S = '1' or Req_L = '1') and ((state_in /= North and state_in /= East and state_in /= West and state_in /= South and state_in /= Local) or (Grant_N = '0' and Grant_E = '0' and Grant_W = '0' and Grant_S = '0' and Grant_L = '0') )) then  \n")
	...
	if '8' in checker_id:
		...
		arbiter_checker_vhd.write("if ( (Req_N = '1' or Req_E = '1' or Req_W = '1' or Req_S = '1' or Req_L = '1') and next_state_out /= North and next_state_out /= East and next_state_out /= West and next_state_out /= South and next_state_out /= Local) then \n")
	...
	if '9' in checker_id:
		...
		arbiter_checker_vhd.write("process(Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin\n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '0' and Req_W = '0' and Req_S = '0' and Req_L = '0') and next_state_out /= IDLE) then\n")
	...
	if '10' in checker_id:
		...
		arbiter_checker_vhd.write("if (state_in /= IDLE and state_in /= North and state_in /= East and state_in /= West and state_in /= South and state_in /= Local ) then \n")
	...
	if '11' in checker_id:
		...
		arbiter_checker_vhd.write("	if ( (Req_N = '1' and Req_E = '0' and Req_W = '0' and Req_S = '0' and Req_L = '0') and RTS_FF = '1' and DCTS = '1' and state_in /= North) then \n")
	...
	if '12' in checker_id:
		arbiter_checker_vhd.write("process(RTS_FF, DCTS, Req_N, Req_E, Req_W, Req_S, Req_L, state_in) begin \n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '1' and Req_W = '0' and Req_S = '0' and Req_L = '0') and RTS_FF = '1' and DCTS = '1' and state_in /= East) then \n")
	...
	if '13' in checker_id:
		arbiter_checker_vhd.write("process(RTS_FF, DCTS, Req_N, Req_E, Req_W, Req_S, Req_L, state_in) begin \n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '0' and Req_W = '1' and Req_S = '0' and Req_L = '0') and RTS_FF = '1' and DCTS = '1' and state_in /= West) then \n")
	...
	if '14' in checker_id:
		arbiter_checker_vhd.write("process(RTS_FF, DCTS, Req_N, Req_E, Req_W, Req_S, Req_L, state_in) begin \n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '0' and Req_W = '0' and Req_S = '1' and Req_L = '0') and RTS_FF = '1' and DCTS = '1' and state_in /= South) then \n")
	...
	if '15' in checker_id:
		arbiter_checker_vhd.write("process(RTS_FF, DCTS, Req_N, Req_E, Req_W, Req_S, Req_L, state_in) begin \n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '0' and Req_W = '0' and Req_S = '0' and Req_L = '1') and RTS_FF = '1' and DCTS = '1' and state_in /= Local) then \n")
	...
	if '16' in checker_id:
		arbiter_checker_vhd.write("-- If there is a request from Arbiter to next router/NI, but the FIFO of the next router is full (not ready), previous state must be stored in state_in! \n")
	...
	if '18' in checker_id:
		...
		arbiter_checker_vhd.write("	if ( (state = North) and RTS_FF = '1' and DCTS = '1' and (Grant_N = '0' or RTS_FF_in = '1') ) then \n")
	...
	if '19' in checker_id:
		...
		arbiter_checker_vhd.write("	if ( (state = East) and RTS_FF = '1' and DCTS = '1' and (Grant_E = '0' or RTS_FF_in = '1') ) then \n")
	...
	if '20' in checker_id:
		...
		arbiter_checker_vhd.write("	if ( (state = West) and RTS_FF = '1' and DCTS = '1' and (Grant_W = '0' or RTS_FF_in = '1') ) then \n")
	...
	if '21' in checker_id:
		...
		arbiter_checker_vhd.write("	if ( state = South and RTS_FF = '1' and DCTS = '1' and (Grant_S = '0' or RTS_FF_in = '1') ) then \n")
	...
	if '22' in checker_id:
		...
		arbiter_checker_vhd.write("	if ( state = Local and RTS_FF = '1' and DCTS = '1' and (Grant_L = '0' or RTS_FF_in = '1') ) then \n")
	...
	if '34' in checker_id:
		...
		arbiter_checker_vhd.write("	if (state /= North and RTS_FF = '1' and DCTS = '1' and (Grant_N = '1' or Xbar_sel = "00001") ) then \n")
	...
	if '35' in checker_id:
		...
		arbiter_checker_vhd.write("	if (state /= East and RTS_FF = '1' and DCTS = '1' and (Grant_E = '1' or Xbar_sel = "00010") ) then \n")
	...
	if '36' in checker_id:
		...
		arbiter_checker_vhd.write("	if (state /= West and RTS_FF = '1' and DCTS = '1' and (Grant_W = '1' or Xbar_sel = "00100") ) then \n")
	...
	if '37' in checker_id:
		...
		arbiter_checker_vhd.write("	if (state /= South and RTS_FF = '1' and DCTS = '1' and (Grant_S = '1' or Xbar_sel = "01000") ) then \n")
	...
	if '38' in checker_id:
		...
		arbiter_checker_vhd.write("	if (state /= Local and RTS_FF = '1' and DCTS = '1' and (Grant_L = '1' or Xbar_sel = "10000") ) then \n")
	...
	if '39' in checker_id:
		...
		arbiter_checker_vhd.write("	if ( state = IDLE and (Req_L = '0' and Req_N = '0' and Req_E = '0' and Req_W = '0' and Req_S = '1') and next_state_out /= South) then \n")
	...
	if '40' in checker_id:
		arbiter_checker_vhd.write("process(state, Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( state = Local and (Req_L = '0' and Req_N = '0' and Req_E = '0' and Req_W = '0' and Req_S = '1') and next_state_out /= South) then \n")
	...
	if '41' in checker_id:
		arbiter_checker_vhd.write("process(state, Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( state = North and (Req_L = '1' and Req_N = '0' and Req_E = '0' and Req_W = '0' and Req_S = '0') and next_state_out /= Local) then \n")
	...
	if '42' in checker_id:
		arbiter_checker_vhd.write("process(state, Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( state = East and (Req_L = '0' and Req_N = '1' and Req_E = '0' and Req_W = '0' and Req_S = '0') and next_state_out /= North) then \n")
	...
	if '43' in checker_id:
		arbiter_checker_vhd.write("process(state, Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( state = West and (Req_L = '0' and Req_N = '0' and Req_E = '1' and Req_W = '0' and Req_S = '0') and next_state_out /= East) then \n")
	...
	if '44' in checker_id:
		arbiter_checker_vhd.write("process(state, Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( state = South and (Req_L = '0' and Req_N = '0' and Req_E = '0' and Req_W = '1' and Req_S = '0') and next_state_out /= West) then \n")
	...
	if '45' in checker_id:
		arbiter_checker_vhd.write("process(Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( (Req_N = '1' and Req_E = '0' and Req_W = '0' and Req_S = '0' and Req_L = '0') and next_state_out /= North) then \n")
	...
	if '46' in checker_id:
		arbiter_checker_vhd.write("process(Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '1' and Req_W = '0' and Req_S = '0' and Req_L = '0') and next_state_out /= East) then \n")
	...
	if '47' in checker_id:
		arbiter_checker_vhd.write("process(Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '0' and Req_W = '1' and Req_S = '0' and Req_L = '0') and next_state_out /= West) then \n")
	...
	if '48' in checker_id:
		arbiter_checker_vhd.write("process(Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '0' and Req_W = '0' and Req_S = '1' and Req_L = '0') and next_state_out /= South) then \n")
	...
	if '49' in checker_id:
		arbiter_checker_vhd.write("process(Req_N, Req_E, Req_W, Req_S, Req_L, next_state_out) begin \n")
		arbiter_checker_vhd.write("	if ( (Req_N = '0' and Req_E = '0' and Req_W = '0' and Req_S = '0' and Req_L = '1') and next_state_out /= Local) then \n")
	...
	if '51' in checker_id:
		...
		arbiter_checker_vhd.write("	if (state /= IDLE and RTS_FF = '1' and DCTS = '1' and Grant_N = '0' and Grant_E = '0' and Grant_W = '0' and Grant_S = '0' and Grant_L = '0') then \n")
